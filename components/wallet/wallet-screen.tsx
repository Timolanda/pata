...
// Import wallet button components
import { ReceiveButton } from "./buttons/receive-button"
import { SendButton } from "./buttons/send-button"
import { StakeTokensButton } from "./buttons/stake-tokens-button"
import { TreasureUpgradesButton } from "./buttons/treasure-upgrades-button"
import { RewardRedemptionButton } from "@/components/wallet/buttons/reward-redemption-button"
import { StakingRewardsButton } from "@/components/wallet/buttons/staking-rewards-button"
      ...
      <div className="p-4">
        {!connected ? (
          <Card className="game-card mb-6">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <Button className="game-button flex items-center justify-center h-16" onClick={handleConnect}>
                  <Image
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <TreasureUpgradesButton />
              <RewardRedemptionButton balance={1250} />
            </div>
